...
API_ID = int(environ.get('API_ID', '19234664')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '29c2f3b3d115cf1b0231d816deb271f5')  # API Hash from my.telegram.org
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002376137081")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/whHV3mLp/photo-2025-11-26-05-37-21-7576904037694439492.jpg')    # QR code image for payments
OWNER_ID = environ.get('OWNER_ID', 'ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɢʜᴛ ɴᴏᴡ')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nofeha5538:nofeha5538@cluster0.9k3df.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://rosivah112:rosivah112@cluster0.xnkfp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', False))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002376137081'))  # Notification of sent to your channel
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "e3686f3ba4226ca56b94a0faf3edf4f5273ba8c1")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "nanolinks.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "e3686f3ba4226ca56b94a0faf3edf4f5273ba8c1")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "nanolinks.in") # Shortener website for third website
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+3S41nEK-z3YxYjI1') # Update channel link for the bot
